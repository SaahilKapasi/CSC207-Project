        ...
        <div id="about" className="bg-gray-100 p-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="mb-4">
              ...
              concern for financial applications like CashApp. Indirect bias
              arises when a machine learning model uses seemingly neutral
              features that disproportionately impact protected groups.
            </p>
            ...
            <p className="mb-4">
              The failure to sufficiently tackle bias in CashApp's machine
              learning models poses risks such as loss of user trust and
              restricted access for certain populations.
            </p>
            ...
            <p className="mb-4">
              The project consists of a backend (FastAPI) for processing data
              and a frontend (React) for user interaction and visualization.
            </p>
